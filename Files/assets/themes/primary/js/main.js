(function ($) {
  ...
  $(document).ready(function () {
    ...
    $(".toggle-password").on("click", function () {
      $(this).toggleClass("ti ti-eye ti ti-eye-off");
    ...
    $('.banner-slider').slick({
      ...
      fade: true,
      pauseOnHover: false,
      nextArrow: '<button type="button" class="slick-next"><i class="ti ti-arrow-right"></i></button>',
      prevArrow: '<button type="button" class="slick-prev"><i class="ti ti-arrow-left"></i></button>',
    });
